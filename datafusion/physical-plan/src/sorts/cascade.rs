...
impl<C: CursorValues + Send + Unpin> SortPreservingCascadeStream<C> {
    pub(crate) fn new(
...
impl<C: CursorValues + Send + Unpin> Stream for SortPreservingCascadeStream<C> {
...
impl<C: CursorValues + Send + Unpin> RecordBatchStream for SortPreservingCascadeStream<C> {
